...
const Index = () => {
  ...
  const featuredServices = [
    // Top 4 prioritized services
    {
      ...
      description:
        "Professional glass cleaning services for residential and commercial buildings. We ensure spotless, streak-free windows and facades using safe and effective cleaning methods. (Image coming soon)",
      icon: (
        <svg
      ...
      image: `${import.meta.env.BASE_URL}images/serviceimages/glassclean.jpg`, // Placeholder image
    },
    {
